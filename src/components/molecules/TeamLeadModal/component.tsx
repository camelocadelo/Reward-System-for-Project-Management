...
import { FormValues, FormInputs, TeamLeadModalProps } from './types';
import Close from 'assets/images/close.png';

function TeamLeadModal(props: TeamLeadModalProps): JSX.Element {
  const { onCloseModal, onTeamLeadFormSubmit } = props;
  ...
  return (
    <div className="project-modal">
      ...
      <form onSubmit={handleSubmit(onTeamLeadFormSubmit)}>
